    ...
    <div class="header-top">
        <div class="container">
            ...
            <div class="header-right">
                ...
                <a href="{{ asset('frontend') }}/assets/ajax/login.html" class="d-lg-show login sign-in"><i
                        class="w-icon-account"></i>Sign In</a>
                <span class="delimiter d-lg-show">/</span>
                <a href="{{ asset('frontend') }}/assets/ajax/login.html"
        ...
        <div class="container">
            <div class="header-left mr-md-4">
                ...
                <a href="{{ route('HomePage') }}" class="logo ml-lg-0">
                    <img src="{{asset('backend/company_logo/bitlogo.png')}}" alt="logo" width="144"
                        height="45" />
                </a>
                    ...
                    <div class="dropdown-box">
                        ...
                        <div class="products">
                            <div class="product product-cart">
                                ...
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{ asset('frontend') }}/assets/images/cart/product-1.jpg"
                            ...
                            <div class="product product-cart">
                                ...
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{ asset('frontend') }}/assets/images/cart/product-2.jpg"
                                            ...
                                            @foreach ($category->children as $subcategory)
                                                <li>
                                                    ...
                                                    @if ($subcategory->children->count())
                                                        <ul>
                                                            @foreach ($subcategory->children as $subcategory_1)
                                                                <li><a
                                                                        href="shop-fullwidth-banner.html">{{ $subcategory_1->name }}</a>
                                                                </li>
                                                            @endforeach
                                                        </ul>
                                                    @endif
