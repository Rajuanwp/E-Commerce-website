                            ...
                            <div class="product-gallery product-gallery-sticky">
                                ...
                                'navigation': {
                                    ...
                                    <div class="swiper-wrapper row cols-1 gutter-no">
                                        ...
                                        {{-- <div class="swiper-slide">
                                            <figure class="product-image">
                                                <img src="{{ asset('frontend') }}/assets/images/products/default/2-800x900.jpg"
                                        ...
                                        <div class="swiper-slide">
                                            <figure class="product-image">
                                                <img src="{{ asset('frontend') }}/assets/images/products/default/3-800x900.jpg"
                                        ...
                                        <div class="swiper-slide">
                                            <figure class="product-image">
                                                <img src="{{ asset('frontend') }}/assets/images/products/default/4-800x900.jpg"
                                        ...
                                        <div class="swiper-slide">
                                            <figure class="product-image">
                                                <img src="{{ asset('frontend') }}/assets/images/products/default/5-800x900.jpg"
                                        ...
                                        <div class="swiper-slide">
                                            <figure class="product-image">
                                                <img src="{{ asset('frontend') }}/assets/images/products/default/6-800x900.jpg"
                                ...
                                'navigation': {
                                    ...
                                    <div class="product-thumbs swiper-wrapper row cols-4 gutter-sm">
                                        ...
                                        <div class="product-thumb swiper-slide">
                                            <img src="{{ asset($img->photo_name) }}" alt="Product Thumb" width="800" height="900">
                                        </div>
                                    @endforeach
                        ...
                        <div class="col-md-6 mb-4 mb-md-6">
                            <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                @if ($product->product_qty > 0)
                                    <span class="badge rounded-pill bg-info text-dark">In Stock</span>
                                @else
                                    <span class="badge rounded-pill bg-primary"> Stock Out</span>
                                @endif
                                <h1 class="product-title">{{ $product->product_name }}</h1>
                                <div class="product-bm-wrapper">
                                    <figure class="brand">
                                        <img src="{{ asset('frontend') }}/assets/images/products/brand/brand-1.jpg"
                                    ...
                                    @else
                                        ...
                                        <div class="d-flex align-items-center product-variations">
                                            @foreach ($product_color as $color)
                                                <a href="#" class="color" value="{{ $color }}"
                        ...
                        <div class="bought-together-products row mt-8 pb-4">
                            <div class="product product-wrap text-center">
                                <figure class="product-media">
                                    <img src="{{ asset('frontend') }}/assets/images/products/default/bought-1.jpg"
                            ...
                            <div class="product product-wrap text-center">
                                <figure class="product-media">
                                    <img src="{{ asset('frontend') }}/assets/images/products/default/bought-2.jpg"
                                        alt="Product" width="138" height="138" />
                                    <div class="product-checkbox">
                            ...
                            <div class="product product-wrap text-center">
                                <figure class="product-media">
                                    <img src="{{ asset('frontend') }}/assets/images/products/default/bought-3.jpg"
                                        alt="Product" width="138" height="138" />
                                    <div class="product-checkbox">
                            ...
                            <div class="tab-pane active" id="product-tab-description">
                                <div class="row mb-4">
                                    <div class="col-md-6 mb-5">
                                        ...
                                        <p class="mb-4">{{ $product->long_descp }}</p>
                                        <ul class="list-type-check">
                                            <li>{{ $product->long_descp }}
                                            </li>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6 mb-4">
                                        <figure class="vendor-banner br-sm">
                                            <img src="{{ asset('frontend') }}/assets/images/products/vendor-banner.jpg"
                                    ...
                                    <div class="col-md-6 pl-2 pl-md-6 mb-4">
                                        <div class="vendor-user">
                                            <figure class="vendor-logo mr-4">
                                                <a href="#">
                                                    <img src="{{ asset('frontend') }}/assets/images/products/vendor-logo.jpg"
                        ...
                        <div class="sticky-sidebar">
                            ...
                            <div class="widget widget-banner mb-9">
                                <div class="banner banner-fixed br-sm">
                                    <figure>
                                        <img src="{{ asset('frontend') }}/assets/images/shop/banner3.jpg"
